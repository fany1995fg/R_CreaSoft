...
public class FrmRanuras extends JInternalFrame implements ActionListener{
	...
	public FrmRanuras() {
		...
		ranura.add(separator_1);
		
		lblListaDeMarcas = new JLabel("Lista de Ranuras:");
		lblListaDeMarcas.setBounds(57, 149, 153, 20);
		lblListaDeMarcas.setFont(new Font("Tahoma", Font.BOLD, 12));
		ranura.add(lblListaDeMarcas);
		
		JPanel panel_1 = new JPanel();
		panel_1.setBounds(473, 174, 486, 155);
		...
		JLabel lblEspesoresp = new JLabel("Espesor(ESP):");
		...
		JCheckBox chckbxComun = new JCheckBox("Comun");
		chckbxComun.setBounds(290, 85, 120, 23);
		panel_1.add(chckbxComun);
		
		JCheckBox chckbxDistanciaBordeLateral = new JCheckBox("Distancia Borde Lateral=0");
		...
		ranura.add(chckbxNewCheckBox_1);
